...
export default function EditArticlePage() {
    ...
    // Handle slug which might be an array for catch-all segments
    const slug = Array.isArray(params.slug) ? params.slug.map(s => decodeURIComponent(s)).join('/') : decodeURIComponent(params.slug || '');
                ...
                try {
                    ...
                    if (item) {
                        ...
                        setFormData({
                            ...
                            contentType: parsed.contentType || 'article' // Default to article for backward compatibility
                        });
                        setContentBlocks(parsed.contentBlocks || []);
                    } else {
                        // Fallback: try default slug if url decoded failed
                        console.log(`Article with key page-${slug} not found.`);
